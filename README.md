...
b. Installation and Setup
       1. Clone the repository clone it using git clone
       2. navigate to both client and server  directory
       3. execute npm install on both directories
       4. navigate to client and execute npm run dev
       5. goto the localhost address with port
