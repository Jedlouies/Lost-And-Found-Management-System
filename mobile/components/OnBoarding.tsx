...
const handleFinishOnboarding = async (router) => {
...
export default function Onboarding() {
  ...
  // 2. Create an animated value to control the float effect
  const floatAnim = useRef(new Animated.Value(0)).current;

  // 3. Set up the looping animation when the component mounts
  useEffect(() => {
    Animated.loop(
      Animated.sequence([
  ...
  return (
    <SafeAreaView style={styles.container}>
      <TouchableOpacity
        ...
        onPress={() => handleFinishOnboarding(router)}
      >
      ...
      >
        ...
        <View key="1" style={styles.page}>
          <View style={styles.circle}>
            ...
            {/* 4. Use Animated.Image and apply the transform style */}
            <Animated.Image
        ...
        <View key="4" style={styles.page}>
          ...
          <TouchableOpacity style={styles.button} onPress={() => handleFinishOnboarding(router)}>
            <Text style={styles.buttonText}>Get Started</Text>
          </TouchableOpacity>
        </View>
      </PagerView>

      {/* Indicator container remains the same */}
