  ...
  >
    <p style={{ color: "black", fontSize: "20px", textAlign: 'center'}}>
      ...
      <div className='matching-buttons-footer'>
        ...
        <button style={{top: '92%', marginLeft: '80%'}} className={`${location.pathname === `/users/lost-items/procedure/item-details/${user?.uid}` ? 'active' : ''}`} onClick={() => handleMatchAnother(`/users/lost-items/procedure/item-details/${user?.uid}`)}>
