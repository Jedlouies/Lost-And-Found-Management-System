...
const styles = {
    ...
    // Updated wrapper style for better spacing
    infoPanelWrapper: {
        marginBottom: '30px',
        animation: 'fadeIn 0.5s ease-in-out', // Added subtle animation
    },
    ...
    <>
      ...
      <div style={styles.homeBody}>
        <div style={styles.pageContainer}>
            ...
            {/* 2. Info Panel Section (Moved Below Banner) */}
