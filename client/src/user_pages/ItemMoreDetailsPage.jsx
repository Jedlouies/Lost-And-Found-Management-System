...
const styles = {
    ...
    claimButton: { // Style used for the action button
        ...
        fontWeight: '600',
        cursor: 'pointer',
        marginTop: '30px', // FIX: Reduced top margin from original large value
...
function ItemMoreDetailsPage() {
  ...
  // --- FUNCTIONALITY: FETCH ITEM DATA (UNCHANGED) ---
  useEffect(() => {
  ...
  const ItemImagePath = item.images?.length > 0 ? item.images[0] : 'placeholder_image_url.png';
  ...
  const ownerIsGuest = type === "lost" ? item.isGuest : item.claimedBy?.isGuest;
  const founderIsGuest = type === "lost" ? item.foundBy?.isGuest : item.isGuest;
        ...
        <div style={styles.itemContainer}>
            ...
            <div style={styles.imageSection}>
                ...
                {showClaimButton && (
                    <button 
                        onClick={handleClaim}
                        style={{...styles.claimButton, backgroundColor: type === "lost" ? '#143447' : '#143447' }}
                    >
            ...
            <div style={styles.detailsSection}>
                ...
                <p style={styles.detailP}>
                    {type === "lost" 
                        ? item.howItemLost || "No details provided" 
                ...
                <div style={styles.userInfoRow}>
                    {renderUser(ownerInfo, ownerIsGuest)}
                ...
                <div style={styles.userInfoRow}>
                    {renderUser(founderInfo, founderIsGuest)}
                    <p style={styles.userNameInfo}>
