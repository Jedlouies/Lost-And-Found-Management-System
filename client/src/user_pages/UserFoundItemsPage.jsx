...
function UserFoundItemsPage() {
  ...
  useEffect(() => {
    ...
    // Toggle save/unsave (always update Firestore)
        ...
        <h1 style={{ fontSize: '30px', alignItems: 'center', top: '9%', fontWeight: '500', marginLeft: '20px', color: '#475C6F' }}>
          ...
          <div className='user-lost-searchBar'>
            ...
            >
              ...
              <option value="Accessories">Clothing & Apparel</option>
              <option value="Electronics">Bags & Luggage</option>
              <option value="Documents">Documents & IDs</option>
              <option value="Accessories">Books & Stationery</option>
              <option value="Electronics">Household Items</option>
              <option value="Documents">Sports & Fitness</option>
              <option value="Accessories">Health & Personal Care</option>
              <option value="Electronics">Toys & Games</option>
              <option value="Documents">Food & Beverages</option>
              <option value="Accessories">Automotive Items</option>
              <option value="Electronics">Musical Instruments</option>
              <option value="Documents">Pet Items</option>
