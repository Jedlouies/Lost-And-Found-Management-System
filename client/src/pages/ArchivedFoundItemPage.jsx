...
function ArchivedFoundItemsPage() {
  ...
  // --- END: Copied Styles from FoundItemsPage.jsx ---
  
  // --- Person Renderer Component (Internal) ---
    ...
    <>
      ...
      <div style={styles.foundItemBody}>
        <div style={styles.foundItemContainer}>
          <h1 style={styles.headerH1}>Archived Found Items</h1>
            ...
            <table style={styles.table}>
              <thead style={styles.tableHead}>
                <tr>
                  ...
                  <th style={styles.tableHeaderCell}>Owner (Claimed By)</th>
                ...
                {displayedItems.length > 0 ? (
                  displayedItems.map((item, index) => (
                    <tr style={styles.tableRow} key={index}>
                      ...
                      <td style={styles.tableDataCell}>
                        <PersonDetailsRenderer 
                            userData={item.claimedBy} 
                            isGuest={item.claimedBy?.isGuest}
                        />
                      </td>
