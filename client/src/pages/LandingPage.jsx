      ...
      <div className='page-body'>
        ...
        <div className='page-features'>
            ...
            <section className='features-container'>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-robot" viewBox="0 0 16 16" style={{top: '15%', left: '-30%'}}>
            ...
            <section className='features-container' style={{top: '52%', left: '30%'}}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-binoculars" viewBox="0 0 16 16" style={{top: '10%', left: '77%'}}>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" fill="currentColor" class="bi bi-bell" viewBox="0 0 16 16" style={{top: '20%', left: '7%'}}>
            ...
            <section className='features-container' style={{top: '78%', left: '30%'}}>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-filter-square" viewBox="0 0 16 16" style={{top: '20%', left: '75%'}}>
