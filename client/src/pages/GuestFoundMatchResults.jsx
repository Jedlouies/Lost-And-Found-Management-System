...
export default function GuestFoundMatchResults(foundItem) {
  ...
  return (
    <>
          {selectedItem && (
        <div className="floating-panel" style={{position: 'absolute', zIndex: 1000, backgroundColor: 'white',color: 'black', borderRadius: '10px', padding: '20px', width: '700px', height: '400px', top: '50px', left: '50%', transform: 'translateX(-50%)', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)'}}>
    ...
    <div className="p-6" style={{position: 'absolute',  padding: '20px', backgroundColor: '#D9D9D9', width: '100%', height: '130vh'}}>
      ...
      <div className='matching-buttons-footer'>
        ...
        <button style={{top: '92%', marginLeft: '80%'}}  onClick={() => handleMatchAnother(`/guest/found/${currentUser?.uid || "anonymous"}`)}>
