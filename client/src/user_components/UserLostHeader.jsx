...
import './styles/UserLostHeader.css'
  ...
  return (
    ...
    <div className='header-body'>
        ...
        <div className='lost-post'>
            <button className={`lost-post-button  ${location.pathname === `/users/lost-items/procedure/${user?.uid}` ? 'active' : ''}`} onClick={() => handlePost(`/users/lost-items/procedure/${user?.uid}`)}>
