...
import './styles/UserFoundHeader.css'
  ...
  return (
    ...
    <div className='header-body'>
        ...
        <div className='found-post'>
            <button className={`found-post-button  ${location.pathname === `/users/found-items/procedure/${user?.uid}` ? 'active' : ''}`} onClick={() => handlePost(`/users/found-items/procedure/${user?.uid}`)}>
        ...
        <div className='header-right-found'>
          <svg ref={bellRef} xmlns="http://www.w3.org/2000/svg" width="25" height="20" fill="white" class="bi bi-bell" viewBox="0 0 16 16" onClick={toggleNotifyPanel} style={{ cursor: 'pointer' }}>
...
export default UserFoundHeader